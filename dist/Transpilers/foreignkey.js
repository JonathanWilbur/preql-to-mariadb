...
var transpileForeignKeyConstraint = function (obj) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        storedProcedureName = obj.spec.databaseName + ".create_fk_" + obj.spec.attributeName;
        foreignKeyName = "fk_" + obj.spec.childStruct + "_" + obj.spec.parentStruct;
        comment = ('comment' in obj.metadata && typeof obj.metadata['comment'] === 'string') ? escape_1.default(obj.metadata['comment']) : '';
        return [2 /*return*/, "ALTER TABLE " + obj.spec.databaseName + "." + obj.spec.childStruct + "\r\n"
