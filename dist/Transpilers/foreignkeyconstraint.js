...
var transpileForeignKeyConstraint = function (obj) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        storedProcedureName = obj.spec.databaseName + ".create_" + obj.spec.name;
        return [2 /*return*/, "DROP PROCEDURE IF EXISTS " + storedProcedureName + ";\r\n"
                ...
                + ("\t(\r\n\t\t" + obj.spec.child.key.map(function (k) { return k.attributeName; }).join(',\r\n\t\t') + "\r\n\t)\r\n")
                + ("\tREFERENCES " + obj.spec.parent.struct + "\r\n")
                + ("\t(\r\n\t\t" + obj.spec.parent.key.map(function (k) { return k.attributeName; }).join(',\r\n\t\t') + "\r\n\t)\r\n")
